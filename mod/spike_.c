...
#define nN nN_spike
 double nN = 3;
#define tauh tauh_spike
 double tauh = 0.5;
#define taum taum_spike
 double taum = 0.05;
#define taun taun_spike
 double taun = 1;
 ...
 "taum_spike", &taum_spike,
 "tauh_spike", &tauh_spike,
 "taun_spike", &taun_spike,
 "mN_spike", &mN_spike,
 "nN_spike", &nN_spike,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 spike spike_.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 47 in file spike_.mod:\n\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "spike_.mod";
static const char* nmodl_file_text = 
  "TITLE HH channel\n"
  "\n"
  "NEURON {\n"
  ...
  "	RANGE gnabar, gkbar,vshift\n"
  "	GLOBAL taun,taum,tauh\n"
  "	GLOBAL mN,nN\n"
  "}\n"
  "\n"
  "UNITS {\n"
