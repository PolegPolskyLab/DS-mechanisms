...
#define nrn_init _nrn_init__calrgcfix
#define _nrn_initial _nrn_initial__calrgcfix
#define nrn_cur _nrn_cur__calrgcfix
#define _nrn_current _nrn_current__calrgcfix
#define nrn_jacob _nrn_jacob__calrgcfix
#define nrn_state _nrn_state__calrgcfix
#define _net_receive _net_receive__calrgcfix 
#define states states__calrgcfix 
#define trates trates__calrgcfix 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_calrgcfix", _hoc_setdata,
 "trap0_calrgcfix", _hoc_trap0,
 "trates_calrgcfix", _hoc_trates,
 0, 0
};
#define trap0 trap0_calrgcfix
 ...
 "gbar_calrgcfix", "mho/cm2",
 "ica_calrgcfix", "mA/cm2",
 "mtau_calrgcfix", "ms",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 calrgcfix calRGCfix.mod\n");
...
static int  trates ( _threadargsprotocomma_ double _lvm ) {
   ...
   b = 0.058 * exp ( - ( _lvm + shift - 10.0 ) / 15.0 ) ;
   minf = a / ( a + b ) ;
   mtau = 1.0 / ( a + b ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "calRGCfix.mod";
static const char* nmodl_file_text = 
  "\n"
